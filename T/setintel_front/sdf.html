  ...
  <body style="background-color: #f0f9fa">
    ...
    <div class="grid lg:grid-cols-3 gap-10 mx-auto max-w-7xl mb-24 lg:px-8">
      <!-- <div
        ...
        class="max-w-sm bg-white border border-gray-200 rounded-lg shadow h-100 hover:border-[#910101] flex flex-col">
        <div
        ...
        <div
          class="rounded-[10px] h-full w-11/12 m-auto bg-red-900 flex flex-col flex-grow mb-3.5">
          <div class="p-5">
      ...
      <div
        ...
        <div id="div2" class="hidden flex-grow pb-3.5">
          <div
            class="rounded-[10px] h-full w-11/12 m-auto bg-red-900 flex flex-col h-full flex-grow mb-3.5">
            <div class="p-5">
              <p class="mb-3 font-normal text-white">
                We specialize in creating dynamic partnerships with local sports
                media and broadcasters, delivering innovative inventory
      ...
      <div
        style="width: 100%; margin: 0 auto"
        class="max-w-sm bg-white border border-gray-200 rounded-lg h-100 shadow hover:border-[#910101]">
        <div
          style="text-align: center; padding-bottom: 15px; padding-top: 10px">
          <p
            class="pt-2 font-bold text-2xl"
        ...
        <div class="pt-5 w-10/12 m-auto">
          <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
            Our strong experience in integrating gambling companies into sports
            OTT platforms ensures seamless and effective collaborations that
      ...
      <div
        ...
        <div class="pt-5 w-10/12 m-auto">
          <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
            Seamlessly integrate partner campaigns on the Setanta Sports landing
            page, driving traffic and engagement with compelling offers.
          </p>
      ...
      <div
        ...
        <div
          id="div4"
          class="hidden w-11/12 m-auto h-full flex flex-col flex-grow mb-3.5">
          <div
            class="rounded-[10px] w-12/13 bg-red-900 flex flex-col flex-grow">
      ...
      <div
        ...
        <div class="w-11/12 m-auto h-full flex flex-col flex-grow">
          <div
            class="rounded-[10px] h-full w-12/13 bg-red-900 flex flex-col flex-grow mb-3.5">
            <div class="flex justify-center items-center pt-7">
              <svg
                width="36"
                height="35"
